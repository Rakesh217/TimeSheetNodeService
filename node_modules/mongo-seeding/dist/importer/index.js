...
class CollectionImporter {
     ...
     */
    constructor(db, collectionInsertManyOptions) {
        this.db = db;
    ...
    importCollection(collection) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            return this.db.insertDocumentsIntoCollection(collection.documents, collection.name, this.collectionInsertManyOptions);
        });
    }
}
